...
@section('title')
    Gallery - Domestic Violence Awareness
@endsection
...
<div class="container-fluid page-header mb-5 wow fadeIn" data-wow-delay="0.1s">
    <div class="container text-center">
        <h1 class="display-4 text-white animated slideInDown mb-4">Domestic Violence Gallery</h1>
    </div>
</div>
<!-- Page Header End -->
                    ...
                    <form action="{{ route('gallery.search') }}" method="GET">
                        <div class="input-group">
                            <input type="text" name="query" class="form-control"
                                placeholder="Search domestic violence..." value="{{ request('query') }}">
