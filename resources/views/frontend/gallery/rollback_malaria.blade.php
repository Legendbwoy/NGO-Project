...
<style>
    .text-block {
        ...
        padding: 20px;
        border-radius: 8px;
        word-wrap: break-word; /* Prevents text from overflowing the box */
        overflow-wrap: break-word; /* Ensures that long words will break properly */
    }
    ...
    /* Ensure the main content area does not overlap the sidebar */
    .col-lg-8 {
        max-width: 100%; /* Ensure it takes up full width in large screens */
    }

    /* Additional tweaks for better text responsiveness */
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="row">
                <!-- Main Gallery Content (Loop Through Rollback Malaria Entries) -->
                <div class="col-lg-8">
                        ...
                        <form action="{{ route('gallery.search') }}" method="GET">
                            <div class="input-group">
                                <input type="text" name="query" class="form-control"
                                    placeholder="Search rollback malaria..." value="{{ request('query') }}">
