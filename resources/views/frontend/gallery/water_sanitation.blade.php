...
@section('content')
    ...
    <div class="container-fluid page-header mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center">
            <h1 class="display-4 text-white animated slideInDown mb-4">Water Sanitation Gallery</h1>
        </div>
    </div>
    <!-- Page Header End -->
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4">
                        ...
                        <form action="{{ route('gallery.search') }}" method="GET">
                            <div class="input-group">
                                <input type="text" name="query" class="form-control"
                                    placeholder="Search water sanitation..." value="{{ request('query') }}">
                    ...
                    <!-- Carousel (Images from water sanitation posts) -->
