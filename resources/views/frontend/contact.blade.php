...
<section class="py-3 py-md-5 py-xl-8" style="background-color: white;">
    <div class="container">
      <div class="row">
        <div class="col-12 col-md-10 col-lg-8">
          {{-- <h3 class="fs-5 mb-2 text-secondary text-uppercase">Contact</h3> --}}
          <h2 class="display-5 mb-4 mb-md-5 mb-xl-8">Please get in touch in one of the following ways.</h2>
        </div>
      </div>
    </div>
              ...
              <div class="row gy-4 gy-xl-5 p-4 p-xl-5">
                  ...
                  <div class="col-12 col-md-6">
                      ...
                      <div class="input-group">
                          ...
                          <input type="tel" class="form-control" id="phone" name="phone" value="" placeholder="Enter your phone number">
                      </div>
                  </div>
                  <div class="col-12">
            ...
            <div class="col-12 col-xl-11">
              <div class="mb-4 mb-md-5">
                ...
                <div>
                  ...
                  <address class="m-0 text-dark">Ghana</address>
                </div>
              </div>
                ...
                <div class="col-12 col-sm-6">
                  <div class="mb-4 mb-sm-0">
                    ...
                    <div>
                      ...
                      <p class="mb-0">
                        <a class="link-secondary text-decoration-none" href="tel:+15057922430">+233 345 67890</a>
                      </p>
                    </div>
                  </div>
                </div>
                <div class="col-12 col-sm-6">
                  <div class="mb-4 mb-sm-0">
                    ...
                    <div>
                      ...
                      <hr class="w-75 mb-3 border-dark-subtle">
                      <p class="mb-0">
                        <a class="link-secondary text-decoration-none" href="mailto:cifbar@yahoo.com">cifbar@yahoo.com</a>
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div>
                ...
                <div>
                  ...
                  <p class="mb-2">Our office opening hours.</p>
                  <hr class="w-50 mb-3 border-dark-subtle">
                  <div class="d-flex mb-1">
                    <p class="text-dark fw-bold mb-0 me-5">Mon - Fri</p>
                    <p class="text-dark mb-0">9am - 5pm</p>
                  </div>
                  {{-- <div class="d-flex">
